            ...
            <div class="flex items-center gap-3">
                ...
                <Link href="/fakultas/dashboard" class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <span class="text-[10px] font-semibold text-[#0D542B] uppercase tracking-wider">{{ currentFakultas.nama_fakultas || 'Admin Fakultas' }}</span>
                    </div>
                </Link>
            </div>
        ...
        >
            ...
            <div class="shrink-0">
                <div class="p-4 border-b border-slate-200 flex items-center justify-between bg-white">
                    <Link href="/fakultas/dashboard" class="flex items-center gap-3 min-w-0">
            ...
            <!-- NAVIGASI MENU UTAMA FAKULTAS (SLIM, FLAT, KOTAK) -->
